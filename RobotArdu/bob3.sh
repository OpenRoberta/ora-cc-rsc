...
PROG_FULL_PATH=$2
TARGET_FULL_PATH=$3
avr-gcc -I${COMP_RESOURCES}/RobotArdu/libraries/Bob3/include -I${COMP_RESOURCES}/RobotArdu/libraries/RobertaFunctions \
...
avr-gcc -L../ora-cc-rsc/RobotArdu/libraries/Bob3/lib -mmcu=atmega88 -Os -Wl,--gc-sections -o ${TARGET_FULL_PATH}.elf ${TARGET_FULL_PATH}.o  -lbob3-smd
